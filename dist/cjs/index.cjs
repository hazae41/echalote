...
var authorities = require('./mods/tor/consensus/authorities.cjs');
...
exports.auth_dirs = authorities.auth_dirs;
exports.parseAuthorities = authorities.parseAuthorities;
exports.parseAuthority = authorities.parseAuthority;
